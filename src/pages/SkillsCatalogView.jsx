...
import { SKILL_AUDIENCE, SKILL_AUDIENCE_META, skillMatchesAudience } from '../constants/skillAudience'
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', maxWidth: '720px' }}>
          ...
          {filtered.length === 0 && (
            <p style={{ color: '#444', fontSize: '0.85rem', textAlign: 'center', padding: '2rem' }}>
              Nenhuma skill de {audienceMeta.label.toLowerCase()} encontrada. Crie em Skills → Criação.
            </p>
          )}
        </div>
      </div>
      ...
      <Modal open={!!editing} onClose={() => setEditing(null)} title="Editar skill" maxWidth="520px">
        {editing && (
          <SkillForm
            ...
            lockAudience={editing.isBuiltin}
          />
        )}
      </Modal>
    </div>
