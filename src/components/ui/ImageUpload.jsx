...
import { Upload, X, Link2, User } from 'lucide-react'
import { Field, Input } from './Field'
import { compressImageToDataUrl } from '../../utils/imageFile'

export function ImageUpload({ value, onChange, label = 'Foto do personagem' }) {
      ...
      <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem', marginBottom: '0.5rem' }}>
            ...
            >
              <Upload size={13} />
              {loading ? 'Processando...' : 'Enviar do computador'}
            </button>
            {value && (
              <button
                type="button"
          ...
          <p style={{ fontSize: '0.65rem', color: '#444', lineHeight: 1.5, margin: 0 }}>
            JPG, PNG, WebP ou GIF · até 5 MB · redimensionada para salvar localmente
          </p>
