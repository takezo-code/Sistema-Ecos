...
/**
 * Specular Button (React Bits) — borda com brilho especular via WebGL.
 * @see https://reactbits.dev/components/specular-button
 */
export default function SpecularButton({
  ...
  useEffect(() => {
    ...
    if (!btn || !fx || disabled) return undefined
